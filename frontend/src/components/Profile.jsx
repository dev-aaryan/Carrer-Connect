...
const Profile = () => {
    ...
    const profilePic = user?.profile?.profilePhoto || defaultProfilePic;
        ...
        <div>
            ...
            <div className='max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8'>
                ...
                <div className='grid w-full max-w-sm items-center gap-1.5'>
                    ...
                    {
                        user?.profile?.resume? <a target='_blank' href={user?.profile?.resume} className='text-blue-500 w-full hover:underline cursor-pointer'>{user?.profile?.resumeOriginalName}</a> : <span>NA</span>
                    }
                </div>
            </div>
